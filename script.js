...
function play() {
  ...
  var ftime = Date.now();
  var timed = (ftime-stime)/1000;
  
  alert('þú svaraðir ' + correct + ' af ' + GAMES_TO_PLAY + ' dæmum rétt á ' + timed.toFixed(2) + ' sekúndum.\nMeðalrétt svör á sekúndu eru ' + (correct/timed).toFixed(2));
...
function ask() {
  ...
  var question = questionGenerator(['+','-','*','/']);
...
function questionGenerator(mod) {
